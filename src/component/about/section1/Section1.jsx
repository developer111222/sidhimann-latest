    ...
    <div className="row">
      <div className="col-lg-6">
        <div className="heading two">
          ...
          <h6>The Sidhiman Foundation is a non-profit organization based in Panipat, 
            Haryana, founded in September 2024 by Pushkar Manchanda. Under the guidance 
            of Chairman Rajinder Kumar Bajaj, we strive to create a positive impact in the 
