      ...
      <section className="page-title-area" style={{ backgroundImage: 'url(assets/img/about.jpg)' }}>
        <div className="container">
          ...
          <ol className="breadcrumb">
            ...
            {/* <p>Empowering the Underserved Through Education and Self-Reliance</p> */}
            <li className="breadcrumb-item active" aria-current="page">Why Women Empowerment?</li>
          </ol>
        </div>
      </section>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="heading two">
                ...
                {/* <p>Empowering the Underserved Through Education and Self-Reliance</p> */}
                <h2 className="pb-3">Why Women Empowerment?</h2>
                <p style={{ color: '#555', fontSize: '16px', fontWeight: 400, textTransform: 'none', lineHeight: '30px' }}>Empowering women is key to sustainable development. We believe in creating opportunities that enable women to lead, inspire, and contribute meaningfully to society.
                </p>
                <div className='what-we-do'>
                  <h3>What We Do</h3>
                  <div className="custom-list">
                    <p>Facilitate vocational training and employment opportunities.
                    </p>
                    <p>Advocate for gender equality and women’s rights.
                    </p>
                    <p>Support women entrepreneurs through micro-finance programs.
                    </p>
                  </div>
          ...
          <div>
            ...
            <div className="col-lg-6">
              <div className="small-donations-img">
                <img className="w-100" alt="charity" src="assets/img/women-empowernment.png" style={{borderRadius:'30px'}} />
              </div>
            </div>
          </div>
        </div>
