            ...
            <section className="page-title-area" style={{ backgroundImage: 'url(assets/img/about.jpg)' }}>
                <div className="container">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Why Rural Development?</li>
                    </ol>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="heading two">
                                ...
                                <h2 className="pb-3">Why Rural Development?</h2>
                                <p style={{ color: '#555', fontSize: '16px', fontWeight: 400, textTransform: 'none', lineHeight: '30px' }}>
                                    Mahatma Gandhi firmly believed that the true strength of a nation lies in the well-being of its rural population. He envisioned a self-reliant rural economy, where every village would be empowered through access to education, healthcare, and economic opportunities. Gandhi saw rural development as essential to India’s independence, as it would ensure that progress was not concentrated in urban areas but was distributed across the nation.<br></br><br></br>
                                    At Sidhiman Foundation, we follow Gandhiji's vision of empowering rural communities by providing the necessary tools for self-sufficiency, social justice, and sustainable development. We believe that the upliftment of rural areas is key to building a just and equitable society, and we are committed to working towards that goal by focusing on education, healthcare, and skills development.
              ...
              - Foster community growth and social cohesion in Panipat and beyond
                        ...
                        <div className="col-lg-6">
                            <div className="small-donations-img" >
                                <img className="w-100" alt="charity" src="assets/img/rural-development.jpg" style={{borderRadius:'20px'}} />
                            </div>
                        </div>
                    </div>
                </div>
