    ...
    <div className="row">
      <div className="col-lg-6">
        <div className="heading two">
          ...
          <h2 className="pb-3">About Sidhiman Foundation:</h2>
        <p style={{color:'#555',fontSize:'16px',fontWeight:400,textTransform:'none',lineHeight:'30px'}}>At Sidhiman Foundation, we know that small steps can create huge transformations. Established in September 2024, our NGO commits to transforming lives and building a brighter future for the marginalized and underprivileged.</p>
        <p style={{color:'#555',fontSize:'16px',fontWeight:400,textTransform:'none',lineHeight:'30px'}}>
        Under the visionary leadership of  Mr. Pushkar Manchanda, Mr. Punyam Manchanda, and  Mr.Rajinder Kumar Bajaj, the Sidhiman Foundation intends to work as a hope for all demographics. Registered under license number 160774 and customer ID U8890DHR2024NPL125223, it will always work to address the problems of the downtrodden, focusing on children, women, and the sick.
        </p>
      ...
      <div className="col-lg-6">
        <div className="small-donations-img">
          <img className="w-100" alt="charity" src="assets/img/charity-7.png" />
        </div>
      </div>
    </div>
  </div>
