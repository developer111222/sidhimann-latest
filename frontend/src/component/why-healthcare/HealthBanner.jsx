            ...
            <section className="page-title-area" style={{ backgroundImage: 'url(assets/img/about.jpg)' }}>
                <div className="container">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Why Healthcare?</li>
                    </ol>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="heading two">
                                ...
                                <h2 className="pb-3">Why Healthcare?</h2>
                                <p style={{ color: '#555', fontSize: '16px', fontWeight: 400, textTransform: 'none', lineHeight: '30px' }}>Access to healthcare is a fundamental right. At Sidhiman Foundation, we aim to bridge the healthcare gap in underserved areas, ensuring that every individual has access to medical care, nutrition, and wellness.</p>
                                <div className='what-we-do'>
                                <h3>What We Do</h3>
                                <div className="custom-list">
                                    <p>Provide curative services, including general health check-ups and dental care.</p>
                                    <p>Deliver health and nutrition services to slums and rural areas.</p>
                                    <p>Establish support groups for mental health and recovery.</p>
                                </div>
              ...
              - Foster community growth and social cohesion in Panipat and beyond
                        ...
                        <div className="col-lg-6">
                            <div className="small-donations-img">
                                <img className="w-100" style={{height:'370px',borderRadius:'30px'}} alt="charity" src="assets/img/why-healthcare.webp" />
                            </div>
                        </div>
                    </div>
                </div>
