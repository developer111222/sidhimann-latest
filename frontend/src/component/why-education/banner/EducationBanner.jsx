...
const EducationBanner = () => {
  ...
  <div className="container">
    ...
    <ol className="breadcrumb">
      ...
      <li className="breadcrumb-item active" aria-current="page">Why Education?</li>
    </ol>
  </div>
</section>
    ...
    <div className="row">
      <div className="col-lg-6">
        <div className="heading two">
          ...
          <h2 className="pb-3">Why Education?</h2>
        <p style={{color:'#555',fontSize:'16px',fontWeight:400,textTransform:'none',lineHeight:'30px'}}>Education is the cornerstone of a self-reliant society. At Sidhiman Foundation, we believe that education is the most powerful tool to break the cycle of poverty and create opportunities for every individual, regardless of their background. By providing access to quality education, we empower communities to dream bigger and achieve more.</p>
      ...
      <div className="col-lg-6">
        <div className="small-donations-img">
          <img className="w-100" style={{borderRadius:'30px'}} alt="charity" src="assets/img/Education.jpg" />
        </div>
      </div>
    </div>
  </div>
